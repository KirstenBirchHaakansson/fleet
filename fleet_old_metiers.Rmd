...
dfad_sum <- summarise(group_by(dfad, fao_area, merged_metier_level6, metier_level6_ret, target_spp_haul, art), 
...
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in == "OTB_MCD_>=120_0_0"] <- "OTB_DEF_>=120_0_0"
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
...
# TBB
mix$mixfish_fleet[mix$fao_area %in% c("27.4.a", "27.4.b", "27.4.c") &
                    mix$metier_in == "TBB_CRU_16-31_0_0"] <- "TBB_CRU_16-31_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% c("27.4.a", "27.4.b", "27.4.c") &
...
test_4 <-
  summarise(
    group_by(
      subset(mix, fao_area %in% c("27.4.a", "27.4.b", "27.4.c")),
      merged_metier_level6,
      metier_level6_ret,
      mixfish_fleet
    ),
