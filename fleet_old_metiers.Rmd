...
for (i in (1:nrow(mix))) {
  ...
  if (mixi$fao_area %in% c("27.7.d")) {
    ...
    mixi$mixfish_fleet[mixi$metier_in %in% c("OTM_SPF_16-31_0_0",
                                             "OTB_SPF_>=120_0_0",
                                             "OTB_DEF_16-31_0_0")] <- "MIS_MIS_0_0_0_IBC" # Data from 1987-2024. OTB_SPF_>=120_0_0 is trips with 999 in mesh and catching PIL and BRS
    ...
    mixi$mixfish_fleet[mixi$metier_in == "No_Matrix6"] <- "MIS_MIS_0_0_0_HC" #Data from 1987-2024. This is a bit rough, but for most of the data it is True. There are two BRS / PIL trips that get this one
  }
...
area_4 <-
  distinct(filter(mix_1, fao_area %in% c("27.4.a", "27.4.b", "27.4.c")),
           metier_level6_ret,
           mixfish_fleet)
