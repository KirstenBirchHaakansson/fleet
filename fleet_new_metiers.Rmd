...
filename_out <- "fleet_new_metiers"
...
dfad <- subset(dfad, year %in% c(2024, 2025))
...
# mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
#                     mix$metier_in %in% c("TBB_DEF_100-119_0_0")] <- "TBB_DEF_100-119_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
...
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    substr(mix$metier_in, 1, 11) %in% c("OTB_MCD_90-", "OTB_MCD_100",
                                                        "OTB_CRU_90-", "OTB_CRU_100",
                                                        "OTB_DEF_90-", "OTB_DEF_100",
                                                        "OTB_DWS_90-", "OTB_DWS_100")] <- "OTB_CRU_90-119_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in%  c("OTB_MCD_>=120_0_0", "OTB_DEF_>=120_0_0", "OTB_CRU_>=120_0_0", "OTM_DEF_>=120_0_0")] <- "OTB_DEF_>=120_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in == "OTB_CRU_70-89_2_35"] <- "OTB_CRU_70-89_2_35_all"

#OTM
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in% c("OTM_SPF_32-69_0_0", "PTM_SPF_32-69_0_0", "OTB_SPF_32-69_0_0")] <- "OTM_SPF_32-69_0_0_all"
...
#SDN & SSC
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in% c("SDN_DEF_16-31_0_0","SDN_DEF_90-119_0_0", "SDN_DEF_>=120_0_0", "SDN_DEF_90-99_0_0", "SDN_DEF_100-119_0_0")] <- "SDN_DEF_>=120_0_0_all"
#Above - I would like to remove SDN_DEF_90-119_0_0 from this, when we decided on this the fleet was insignificant.
#Above - add SDN_DEF_16-31_0_0 this is a weird metier showing up in 2025, but it look like a flatfish fishery 
#This has changed
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in% c("SSC_DEF_90-119_0_0", "SSC_DEF_>=120_0_0",
                                         "SSC_DEF_90-99_0_0", "SSC_DEF_100-119_0_0")] <- "SSC_DEF_>=120_0_0_all"
...
# IBC
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in% metier_ind] <- "MIS_MIS_0_0_0_IBC"
# All other
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
...
mix$mixfish_fleet[mix$fao_area %in% areas &
                    substr(mix$metier_in, 1, 13) %in% c("OTB_MCD_70-99", "OTB_MCD_70-89", "OTB_MCD_90-99",
                                         "OTB_CRU_70-99", "OTB_CRU_70-89", "OTB_CRU_90-99",
                                         "OTB_DEF_70-99", "OTB_DEF_70-89", "OTB_DEF_90-99")] <- "OTB_CRU_70-99_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% areas &
                    substr(mix$metier_in, 1, 13) %in% c("OTB_MCD_100-1",
                                         "OTB_CRU_100-1",
                                         "OTB_DEF_100-1")] <- "OTB_DEF_100-119_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% areas &
                    substr(mix$metier_in, 1, 13) %in% c("OTB_MCD_>=120",
                                         "OTB_CRU_>=120",
                                         "OTB_DEF_>=120",
                                         "OTM_DEF_>=120")] <- "OTB_DEF_>=120_0_0_all"
...
# SPF_32-69
mix$mixfish_fleet[mix$fao_area %in% areas &
                    mix$metier_in %in% c("OTM_SPF_32-39_0_0", "OTM_SPF_40-54_0_0")] <- "OTM_SPF_32-69_0_0_all"
#Above, This is not according to the annex, since I have stolen the fleet from another area
#In the past we would probably not have submitted this fleet, since it normally don't catch
#stocks under WGNSSK & MIXFISH. It has been included, since we now include all effort.
...
# Areas outside c("27.3.a.20", "27.3.a.21", "27.7.d", "27.4.a", "27.4.b", "27.4.c", "27.6.a", "27.6.b")

mix$mixfish_fleet[!(mix$fao_area %in% c("27.3.a.20", "27.3.a.21", "27.7.d", "27.4.a", "27.4.b", "27.4.c", "27.6.a", "27.6.b"))] <- "MIS_MIS"

mis_mis <- subset(mix, mixfish_fleet == "MIS_MIS")
...
# Check metier with mesh 16
test_16 <- subset(fleet, grepl("16", metier_level_6_new))

unique(test_16$mixfish_fleet)

test_ibc <- subset(fleet, mixfish_fleet == "MIS_MIS_0_0_0_IBC")
test_ibc_2 <- distinct(test_ibc, metier_level_6_new, target_spp_haul)
```
...
deep$wgdeep_fleet[deep$metier_in %in% metier_ind] <- "MIS_MIS_0_0_0_IBC"
#Above, data from 1987-2024. SPF_>=120_0_0 is trips mainly with 999 in mesh and catching SPF
#OTB_SPF_>=120_0_0 & OTM_SPF_>=120_0_0 are mainly from unsorted fisheries
