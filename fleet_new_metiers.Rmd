...
dfad <- subset(dfad, year %in% c(2023, 2024))
...
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    substr(mix$metier_in, 1, 11) %in% c("OTB_MCD_90-", "OTB_MCD_100",
                                                        ...
                                                        "OTB_DEF_90-", "OTB_DEF_100")] <- "OTB_CRU_90-119_0_0_all"
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
...
#SDN & SSC
mix$mixfish_fleet[mix$fao_area %in% c("27.3.a.20", "27.3.a.21") &
                    mix$metier_in %in% c("SDN_DEF_90-119_0_0", "SDN_DEF_>=120_0_0", "SDN_DEF_90-99_0_0", "SDN_DEF_100-119_0_0")] <- "SDN_DEF_>=120_0_0_all"
